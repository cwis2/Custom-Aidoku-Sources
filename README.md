...
To use these sources in Aidoku, you must first package them into `.aix` files.
...
These do not display dates for the chapters. I will add more if I need another source.
